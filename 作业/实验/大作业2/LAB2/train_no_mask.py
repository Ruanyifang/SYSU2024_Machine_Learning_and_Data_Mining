...
from gpt_no_mask import SmallGPT  # 导入b.py中的模型定义
...
# 保存模型
torch.save(model.state_dict(), "sentiment_model_with_no_mask.pth")
print("Model saved as sentiment_model_with_no_mask.pth")
